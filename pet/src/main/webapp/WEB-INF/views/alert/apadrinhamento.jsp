	...
	<div class="list-group">
		<div class="text-center">
			...
			<c:forEach var="alert" items="${loggedNGO.alerts}">
				...
				<c:if test="${alert.voucher.tipo == 2}">
					<div class="alert alert-warning">
				
						<p>
							Alerta de <strong>Apadrinhamento!</strong> <br>
							Esse animal: <h4><span class="label label-info"> ${alert.voucher.pet.name} </span> </h4><br>
							Foi <strong>apadrinhado</strong> por: <h4><span class="label label-info"> ${alert.voucher.user.name} </span></h4>?
							<br><br>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="alert alert-warning">
									...
									<h1><span class="label label-danger">CONFIRMAR A APADRINHAMENTO?</span></h1>
									<br>
									
									<p>
									<form id="register" action="donate" method="post" enctype="multipart/form-data">
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="alert alert-danger">
									...
									<h1><span class="label label-warning">TEM CERTEZA QUE ESSE </span>
									<br><br><span class="label label-warning">APADRINHAMENTO NÃO OCORREU?</span></h1>
									<br>
