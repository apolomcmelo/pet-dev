	...
	<div class="list-group">
		<div class="text-center">
			...
			<c:forEach var="alert" items="${loggedNGO.alerts}">
				...
				<c:if test="${alert.voucher.tipo == 3}">
					<div class="alert alert-warning">
				
						<p>
							Alerta de <strong>Doação!</strong> <br>
							Foi <strong>doado</strong> algo por: <h4><span class="label label-info"> ${alert.voucher.user.name} </span></h4>?
							<br><br>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="alert alert-warning">
									...
									<h1><span class="label label-danger">CONFIRMAR A DOAÇÃO?</span></h1>
									<br>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="alert alert-danger">
									...
									<h1><span class="label label-warning">TEM CERTEZA QUE ESSA</span>
									<br><br><span class="label label-warning"> DOAÇÃO NÃO OCORREU?</span></h1>
									<br>
