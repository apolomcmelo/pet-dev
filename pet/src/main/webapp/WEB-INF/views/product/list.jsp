...
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/res/js/lightbox.js" ></script>
					...
					<c:forEach var="productItem" items="${products}">
						...
						<div class="panel-body">
							...
							<div class="text-right">
								...
								<button class="btn btn-info" data-toggle="modal" data-target="#myModal${productItem.id}" >
								  Editar
								</button>
						...
						<!-- Modal -->
						<div class="modal fade" id="myModal${productItem.id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel${productItem.id}" aria-hidden="true">
						  <div class="modal-dialog">
						    <div class="modal-content">
						      <div class="modal-header">
						        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
						        <h4 class="modal-title" id="myModalLabel${productItem.id}">Editar ${productItem.name}</h4>
						      </div>
						 		     ...
						 		     <div class="modal-body">
										...
										<div class="row">
											...
											<div class="col-md-8 form-group">
												...
												<input type="text" name="name" class="form-control" value="${productItem.name}">
											</div>
								
											<div class="col-md-4 form-group">
												<label for="price">Preço</label>
												<div class="input-group">
													<input type="text" class="form-control" name="price" value="${productItem.price}">
										...
										<div class="row">
											...
											<div class="col-md-3 form-group">
												...
												<input type="text" name="score" class="form-control" value="${productItem.score}">
											</div>
											
											<div class="col-md-4 form-group">
												<label for="linkPhoto">Link Foto</label> 
												<input type="text" name="linkPhoto" class="form-control" value="${productItem.linkPhoto}">
											</div>
											
											<div class="col-md-4 form-group">
												<label for="linkAnuncio">Link Anuncio</label> 
												<input type="text" name="linkAnuncio" class="form-control" value="${productItem.linkAnuncio}">
											</div>
										</div>
