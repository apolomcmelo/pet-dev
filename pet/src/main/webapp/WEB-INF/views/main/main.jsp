<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<link rel="stylesheet" type="text/css" href='${pageContext.servletContext.contextPath}/res/css/bootstrap.min.css' />
<link rel="stylesheet" type="text/css" href='${pageContext.servletContext.contextPath}/res/css/bootstrap-theme.min.css' />
<link rel="stylesheet" type="text/css" href='${pageContext.servletContext.contextPath}/res/css/util.css' />
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/res/js/jquery-1.10.2.js" ></script>
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/res/js/jquery-1.8.3.min.js" ></script>
